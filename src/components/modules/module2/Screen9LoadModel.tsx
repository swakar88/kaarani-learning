      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="rounded-2xl p-5 mb-5" style={{ backgroundColor: "#FFFFFF", border: "1.5px solid #E8E8E8" }}>
          ...
          <div className="flex flex-col gap-2">
            {[` ${dataset.name} — types corrected`, " Duplicate rows removed", " Nulls handled appropriately", " Columns renamed & transformed", " Dimension lookup table merged in"].map(step => (
              <div key={step} className="flex items-center gap-2 text-sm" style={{ color: "#111827" }}>
                <span style={{ color: "#2563EB" }}>•</span> {step}
              </div>
            ))}
          </div>
        </div>
